...
from .views import home, ActiveDashboardView, OrderDetailView, MenuCategoryListView, MenuItemListView, OrderItemCreateView, AvailableTablesView, ActivateTableOrderView, DeliverOrderItemView, DeleteOrderItemView, FinalizeOrderView
